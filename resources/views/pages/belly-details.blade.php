...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <div class="logo">
                ...
                <span class="logo-sub">تفاصيل البطن</span>
            </div>
    ...
    <div class="main-container model-selector-page">
        <div class="center-panel">
            <div class="viewer-header">
                <h2><i class="fas fa-heart"></i> تفاصيل أجزاء البطن</h2>
                <p class="page-description">انقر على أي جزء من البطن لتحديد منطقة الألم بدقة</p>
            </div>
            ...
            <div class="viewer-instruction">
                ...
                <p id="instruction-text">انقر على أي جزء من البطن لتحديد منطقة الألم.</p>
            </div>
        </div>

        <div class="right-panel">
            <div class="body-parts-guide">
                <h3><i class="fas fa-map"></i> دليل أجزاء البطن</h3>
                
                <div class="body-parts-list">
                    <div class="body-part-item" data-part="epigastric">
                        <div class="body-part-icon">
                            <i class="fas fa-capsules"></i>
                        </div>
                        <span class="body-part-name">فم المعدة</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="abdomen_up">
                        <div class="body-part-icon">
                            <i class="fas fa-capsules"></i>
                        </div>
                        <span class="body-part-name">البطن العلوية</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="abdomen_down">
                        <div class="body-part-icon">
                            <i class="fas fa-capsules"></i>
                        </div>
                        <span class="body-part-name">البطن السفلية</span>
                        <div class="body-part-indicator"></div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('script-belly-details.js') }}"></script>
    <script>
