...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <div class="logo">
                ...
                <span class="logo-sub">تفاصيل الذراع الأيسر</span>
            </div>
    ...
    <div class="main-container model-selector-page">
        <div class="center-panel">
            <div class="viewer-header">
                <h2><i class="fas fa-hand"></i> تفاصيل أجزاء الذراع الأيسر</h2>
                <p class="page-description">انقر على أي جزء من الذراع الأيسر لتحديد منطقة الألم بدقة</p>
            </div>
            ...
            <div class="model-viewer-container">
                <div id="model-viewer">
                    <div class="loading" id="loading">
                        ...
                        <p>جاري تحميل تفاصيل الذراع الأيسر...</p>
            ...
            <div class="viewer-instruction">
                ...
                <p id="instruction-text">انقر على أي جزء من الذراع الأيسر لتحديد منطقة الألم.</p>
            </div>
        </div>

        <div class="right-panel">
            <div class="body-parts-guide">
                <h3><i class="fas fa-map"></i> دليل أجزاء الذراع الأيسر</h3>
                
                <div class="body-parts-list">
                    <div class="body-part-item" data-part="shoulder_L">
                    ...
                    <div class="body-part-item" data-part="upperarm_L">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                    ...
                    <div class="body-part-item" data-part="elbow_L">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="forearm_L">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                    ...
                    <div class="body-part-item" data-part="wrist_L">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="hand_L">
                        <div class="body-part-icon">
    ...
    <script src="{{ asset('script-left-arm-details.js') }}"></script>
    <script>
        ...
        window.handlePartSelection = function(partName) {
            console.log("يتم تحديث الواجهة للجزء:", partName);
