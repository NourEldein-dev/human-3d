...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <div class="logo">
                ...
                <span class="logo-sub">تفاصيل الرجل اليمنى</span>
            </div>
    ...
    <div class="main-container model-selector-page">
        <div class="center-panel">
            <div class="viewer-header">
                <h2><i class="fas fa-hand"></i> تفاصيل أجزاء الرجل اليمنى</h2>
                <p class="page-description">انقر على أي جزء في الرجل اليمنى لتحديد منطقة الألم بدقة</p>
            </div>
            ...
            <div class="model-viewer-container">
                <div id="model-viewer">
                    <div class="loading" id="loading">
                        ...
                        <p>جاري تحميل تفاصيل الرجل اليمنى...</p>
            ...
            <div class="viewer-instruction">
                ...
                <p id="instruction-text">انقر على أي جزء في الرجل اليمنى لتحديد منطقة الألم.</p>
            </div>
        </div>

        <div class="right-panel">
            <div class="body-parts-guide">
                <h3><i class="fas fa-map"></i> دليل أجزاء الرجل اليمنى</h3>
                
                <div class="body-parts-list">
                    <div class="body-part-item" data-part="thigh_R">
                    ...
                    <div class="body-part-item" data-part="knee_R">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="shin_R">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="ankle_R">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="foot_R">
                        <div class="body-part-icon">
    ...
    <script src="{{ asset('script-right-leg-details.js') }}"></script>
    <script>
