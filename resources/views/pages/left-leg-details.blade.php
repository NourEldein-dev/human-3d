...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <div class="logo">
                ...
                <span class="logo-sub">تفاصيل الرجل اليسرى</span>
            </div>
    ...
    <div class="main-container model-selector-page">
        <div class="center-panel">
            <div class="viewer-header">
                <h2><i class="fas fa-hand"></i> تفاصيل أجزاء الرجل اليسرى</h2>
                <p class="page-description">انقر على أي جزء من الرجل اليسرى لتحديد منطقة الألم بدقة</p>
            </div>
            ...
            <div class="model-viewer-container">
                <div id="model-viewer">
                    <div class="loading" id="loading">
                        ...
                        <p>جاري تحميل تفاصيل الرجل اليسرى...</p>
            ...
            <div class="viewer-instruction">
                ...
                <p id="instruction-text">انقر على أي جزء من الرجل اليسرى لتحديد منطقة الألم.</p>
            </div>
        </div>

        <div class="right-panel">
            <div class="body-parts-guide">
                <h3><i class="fas fa-map"></i> دليل أجزاء الرجل اليسرى</h3>
                
                <div class="body-parts-list">
                    <div class="body-part-item" data-part="thigh_L">
                        <div class="body-part-icon">
                            <i class="fas fa-running"></i>
                        </div>
                        <span class="body-part-name">الفخذ</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="knee_L">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="shin_L">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                        <span class="body-part-name">الساق</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="ankle_L">
                        <div class="body-part-icon">
                    ...
                    <div class="body-part-item" data-part="foot_L">
                        <div class="body-part-icon">
                            <i class="fas fa-shoe-prints"></i>
                        </div>
                        <span class="body-part-name">القدم</span>
                        <div class="body-part-indicator"></div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('script-left-leg-details.js') }}"></script>
    <script>
        ...
        function saveToHistory(part) {
            ...
            // تحديث الأيقونات في الدليل الجانبي تلقائياً لمطابقة الموديل
