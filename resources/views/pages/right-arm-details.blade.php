...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <div class="logo">
                ...
                <span class="logo-sub">تفاصيل الذراع الأيمن</span>
            </div>
    ...
    <div class="main-container model-selector-page">
        <div class="center-panel">
            <div class="viewer-header">
                <h2><i class="fas fa-hand"></i> تفاصيل أجزاء الذراع الأيمن</h2>
                <p class="page-description">انقر على أي جزء من الذراع الأيمن لتحديد منطقة الألم بدقة</p>
            </div>
            ...
            <div class="model-viewer-container">
                <div id="model-viewer">
                    <div class="loading" id="loading">
                        ...
                        <p>جاري تحميل تفاصيل الذراع الأيمن...</p>
            ...
            <div class="viewer-instruction">
                ...
                <p id="instruction-text">انقر على أي جزء من الذراع الأيمن لتحديد منطقة الألم</p>
            </div>
        </div>

        <div class="right-panel">
            <div class="body-parts-guide">
                <h3><i class="fas fa-map"></i> دليل أجزاء الذراع الأيمن</h3>
                
                <div class="body-parts-list">
                    <div class="body-part-item" data-part="shoulder">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                        <span class="body-part-name">الكتف</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="upper_arm">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                        <span class="body-part-name">اليد العلوية</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="elbow">
                        <div class="body-part-icon">
                            <i class="fas fa-compress-arrows-alt"></i>
                        </div>
                        <span class="body-part-name">الكوع</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="forearm">
                        <div class="body-part-icon">
                            <i class="fas fa-bone"></i>
                        </div>
                        <span class="body-part-name">اليد السفلية</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="wrist">
                        <div class="body-part-icon">
                            <i class="fas fa-band-aid"></i>
                        </div>
                        <span class="body-part-name">المعصم</span>
                        <div class="body-part-indicator"></div>
                    </div>

                    <div class="body-part-item" data-part="hand">
                        <div class="body-part-icon">
                            <i class="fas fa-hand-holding-medical"></i>
                        </div>
                        <span class="body-part-name">اليد</span>
                        <div class="body-part-indicator"></div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('script-right-arm-details.js') }}"></script>
    <script>
        ...
        // دالة handlePartSelection المعرفة عالميًا
        ...
        function saveToHistory(part) {
            ...
            // تحديث الأيقونات في الدليل الجانبي تلقائيًا لمطابقة الموديل
